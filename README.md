...
5. Click on the `+` icon next to `Game WAD` and designate the path to your `.wad` file. Any addon WADs in `.pk3` format will be automatically detected within the `.wad` folder.
